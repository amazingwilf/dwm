...
/* enums */
enum { CurResizeBR, CurResizeBL, CurResizeTR,
       CurResizeTL, CurNormal, CurResize, CurMove, 
	   CurLast }; /* cursor */
enum { SchemeNorm, SchemeSel, SchemeFloat, SchemeSticky, SchemeScratchpad,
	   SchemeTagsNorm, SchemeTagsSel, SchemeLtSymbol, SchemeTitle, 
	   SchemeTag1, SchemeTag2, SchemeTag3, SchemeTag4, SchemeTag5, 
	   SchemeTag6, SchemeTag7, SchemeTag8 }; /* color schemes */
...
focus(Client *c)
{
	...
	if (c) {
		...
		grabbuttons(c, 1);
		if (c->scratchkey != 0)
			XSetWindowBorder(dpy, c->win, scheme[SchemeScratchpad][ColBorder].pixel);
		else if (c->issticky)
