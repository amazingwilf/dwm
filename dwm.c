...
enum { SchemeNorm, SchemeSel, SchemeLtSym, SchemeStatus, 
	   SchemeTagsEmpty, SchemeTagsOcc, SchemeTagsSel }; /* color schemes */
  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        ...
        XRDB_LOAD_COLOR("dwm.ltsymfgcolor", ltsymfgcolor);
        XRDB_LOAD_COLOR("dwm.ltsymbgcolor", ltsymbgcolor);
