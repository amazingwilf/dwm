...
/* enums */
enum { CurResizeBR, CurResizeBL, CurResizeTR, CurResizeTL, CurNormal, 
       CurResize, CurMove, CurLast }; /* cursor */
enum { SchemeNorm, SchemeSel, SchemeTagsSel, SchemeTagsOcc,
       SchemeTagsEmpty, SchemeLtSymbol }; /* color schemes */
