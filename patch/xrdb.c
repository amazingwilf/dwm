	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				...
				XRDB_LOAD_COLOR("dwm.stbuttonfloatcolor", stbuttonfloatcolor);
				XRDB_LOAD_COLOR("dwm.stbuttonbgcolor", stbuttonbgcolor);
				XRDB_LOAD_COLOR("dwm.stbuttonbordercolor", stbuttonbordercolor);
				XRDB_LOAD_COLOR("dwm.stbuttonfloatcolor", stbuttonfloatcolor);
				XRDB_LOAD_COLOR("dwm.tag1fg", tag1fg);
				XRDB_LOAD_COLOR("dwm.tag2fg", tag2fg);
				XRDB_LOAD_COLOR("dwm.tag3fg", tag3fg);
				XRDB_LOAD_COLOR("dwm.tag4fg", tag4fg);
				XRDB_LOAD_COLOR("dwm.tag5fg", tag5fg);
				XRDB_LOAD_COLOR("dwm.tag6fg", tag6fg);
				XRDB_LOAD_COLOR("dwm.tag7fg", tag7fg);
				XRDB_LOAD_COLOR("dwm.tag8fg", tag8fg);
				XRDB_LOAD_COLOR("dwm.tag9fg", tag9fg);
